...
class TopPicksDtoTest {
    ...
    fun `TopPickDto should deserialize correctly from JSON`() {
        ...
        assertEquals(0.72, topPick.homeWinProbability ?: 0.0, 0.0001)
        assertEquals(0.18, topPick.drawProbability ?: 0.0, 0.0001)
        assertEquals(0.10, topPick.awayWinProbability ?: 0.0, 0.0001)
        assertEquals(0.60, topPick.bttsProbability ?: 0.0, 0.0001)
        assertEquals(0.88, topPick.compositeScore ?: 0.0, 0.0001)
